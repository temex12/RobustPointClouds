...
launcher = 'none'
load_from = 'C:\\Users\\temex\\Desktop\\mmdet3dProj\\adversarialTrainingOutput\\epoch_40.pth'
log_level = 'INFO'
...
model = dict(
    adversary_cfg=dict(
        noise_level=0.01, num_features=4, type='VoxelPerturber'),
    backbone=dict(
        in_channels=256,
        layer_nums=[
            5,
...
resume = False
submission_prefix = 'C:\\Users\\temex\\Desktop\\mmdet3dProj\\advTestOutput2\\adv_second_kitti_results'
test_cfg = dict()
...
test_evaluator = dict(
    ...
    metric='bbox',
    pklfile_prefix=
    'C:\\Users\\temex\\Desktop\\mmdet3dProj\\advTestOutput2\\adv_second_kitti_results',
    type='KittiMetric')
test_pipeline = [
    dict(
        backend_args=None,
...
work_dir = 'C:\\Users\\temex\\Desktop\\mmdet3dProj\\advTestOutput2'
